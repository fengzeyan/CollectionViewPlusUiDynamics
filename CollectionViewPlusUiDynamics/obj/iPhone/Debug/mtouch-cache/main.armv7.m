...
extern void *mono_aot_module_CollectionViewPlusUiDynamics_info;
extern void *mono_aot_module_monotouch_info;
extern void *mono_aot_module_mscorlib_info;

void monotouch_register_modules ()
{
	mono_aot_register_module (mono_aot_module_CollectionViewPlusUiDynamics_info);
...
void monotouch_setup ()
{
	...
	monotouch_assembly_name = "CollectionViewPlusUiDynamics.exe";
	mono_use_llvm = FALSE;
